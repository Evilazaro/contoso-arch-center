...
:::image source="{{site.baseurl}}/assets/img/transactional-outbox-cosmos/event-handling-before-pattern.png" alt-text="Diagram that shows event handling without the Transactional Outbox pattern.":::
