...
![Diagram showing a single shared multitenant messaging system for all tenants.]({{site.baseurl}}/assets/img/media/messaging/shared-messaging-system.png)
...
![Diagram showing a sharded messaging system. One messaging system contains the queues for tenants A and B, and the other contains the queues for tenant C.]({{site.baseurl}}/assets/img/media/messaging/sharding.png)
...
![Diagram showing different messaging systems for each tenant.]({{site.baseurl}}/assets/img/media/messaging/dedicated-messaging-systems.png)
...
![Diagram showing the Geode pattern, with messaging systems deployed across multiple regions that synchronize together.]({{site.baseurl}}/assets/img/media/messaging/geodes.png)
