...
![GitHub logo](../../../_{{site.baseurl}}/assets/img/github.png) A reference implementation of this architecture is available on [GitHub][ri].

## Architecture

![Diagram that shows the AKS reference architecture.](./{{site.baseurl}}/assets/img/aks.png)
...
![Diagram showing services and pods.](./{{site.baseurl}}/assets/img/aks-services.png)
