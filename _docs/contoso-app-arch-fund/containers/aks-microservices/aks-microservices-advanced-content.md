...
layout: page
title: Microservices
permalink: /aks-microservices-advanced-content/
---
...
![Example of an Application Insights dependency map for an AKS microservices application.]({{site.baseurl}}/assets/img/application-map.png)
