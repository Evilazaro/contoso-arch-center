...
:::image type="content" source="{{site.baseurl}}/assets/img/aks-journey.svg" alt-text="Visualizes your journey through learn, align, baseline, workload, and then into a loop of operate, best practices, iterate.":::
