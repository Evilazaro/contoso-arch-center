...
![Architecture of an AKS PCI infrastructure.]({{site.baseurl}}/assets/img/regulated-architecture.svg)
...
![Network configuration](./{{site.baseurl}}/assets/img/network-topology.svg)
...
![Diagram of the network configuration.](./{{site.baseurl}}/assets/img/flow.svg)
...
![Diagram of Kubernetes API Server operational access with a jump box.](./{{site.baseurl}}/assets/img/aks-jumpbox.svg)
