...
[![Diagram showing mutli-region deployment.](./{{site.baseurl}}/assets/img/aks-multi-cluster.png)](./{{site.baseurl}}/assets/img/aks-multi-cluster-large.png#lightbox)

*Download a [Visio file](https://arch-center.azureedge.net/aks-multi-cluster.vsdx) of this architecture.*

![GitHub logo](../../../_{{site.baseurl}}/assets/img/github.png) A reference implementation of this architecture is available on [GitHub](https://github.com/mspnp/aks-baseline-multi-region).
...
![Diagram showing workload traffic in mutli-region deployment.]({{site.baseurl}}/assets/img/aks-ingress-flow.svg)
...
![Image showing multiple ACR replicas from within the Azure portal.](./{{site.baseurl}}/assets/img/acr-replicas.png)
