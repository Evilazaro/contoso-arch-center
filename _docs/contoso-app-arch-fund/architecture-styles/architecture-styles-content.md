...
![Logical diagram of an N-tier architecture style.](../../../assets/img/n-tier-logical.svg)
...
![Logical diagram of Web-Queue-Worker architecture style.](../../../assets/img/web-queue-worker-logical.svg)
...
![Logical diagram of microservices architecture style.](../../../assets/img/microservices-logical.png)
...
![Diagram of an event-driven architecture style.](../../../assets/img/event-driven.svg)
...
![Logical diagram of a big data architecture style.](../../../assets/img/big-data-logical.svg)
...
| [Big data](./big-data-content/) | Divide a huge dataset into small chunks. Parallel processing on local datasets. | Batch and real-time data analysis. Predictive analysis using ML. |
| [Big compute](./big-compute-content/) | Data allocation to thousands of cores. | Compute intensive domains such as simulation. |
...
[microservices]: ./microservices-content/
[n-tier]: ./n-tier-content/
