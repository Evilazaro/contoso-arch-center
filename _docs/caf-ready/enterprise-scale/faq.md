...
For FAQs about **implementing enterprise-scale architecture**, see [Enterprise-scale implementation FAQ](https://github.com/Evilazaro/Enterprise-scale/wiki/FAQ).
