...
| [Contoso Enterprise-scale Accelerator Landing Zone(https://github.com/Azure/Enterprise-scale/blob/main/docs/reference/wingtip/README.md) 	| The suggested foundation for enterprise-scale adoption.                                                                                                                                                                                                                                                                           	| [Example in GitHub][GitHub-WingTip] 	| [![Dta-button-wingtip]][dta-wingtip] 	|
